...
namespace Doable.Controllers
{
    ...
    public class ECustomerController : Controller
    {
        ...
        public ECustomerController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Create()
        {
            ...
            return View("/Views/Employee/Customers/Create.cshtml", new User { Role = "Client" });
        }
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            return View("/Views/Employee/Customers/Edit.cshtml", customer);
        }
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            return View("/Views/Employee/Customers/Delete.cshtml", customer);
        }
